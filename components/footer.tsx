      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-white text-xl font-bold mb-4">AgriMarket</h3>
            <p className="text-gray-400 leading-relaxed">
              Your trusted platform connecting farmers, agents, and customers for quality agricultural products and services.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/product" className="hover:text-green-500 transition-colors">
                  Products
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/signin" className="hover:text-green-500 transition-colors">
                  Sign In
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <a href="mailto:info@agrimarket.com" className="text-gray-400 hover:text-green-500 transition-colors">
                  info@agrimarket.com
                </a>
              </li>
              <li className="flex items-start">
